...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <!-- <script>
    // Assuming you have a table with id 'employees' and each row has a unique id
    $('#employee_table').on('click', '.edit_employee', function () {
      var employee_id = $(this).closest('tr').attr('id');
      // Assuming you have a function called fetchEmployeeData that fetches the employee data by employeeid
      fetchEmployeeData(employee_id).then(function (employeeData) {
        // Set the employeeid value in the modal
        $('#edit_employeeid').val(employeeData.employee_id);
        // Set other input fields values
        // ...
      });
    });
  </script> -->
